...
def correo(request):
  ...
  if request.method == 'POST':  
        ...
        asunto= request.POST['nombre']+ ' '+ request.POST['apellidos']+ ', '+ request.POST['fecha']+ ' en '+ request.POST['asunto']+ ' con correo '+ request.POST['correo']+ ' \n ' +'Envio su informacion para una consulta con respecto al asunto: '+ request.POST['comentarios']+ ' \n '+ 'En breve sera contactado al numero ' 
